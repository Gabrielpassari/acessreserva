...
const equipe = [
  { id: '1', nome: "ARION PESSIN", descricao: "bla bla bla", imagem: require('../assets/integrantes/arion.png') },
  { id: '2', nome: "GABRIEL PASSARI", descricao: "bla bla bla", imagem: require('../assets/integrantes/gabriel.png') },
  { id: '3', nome: "HENRIQUE JOSHUA", descricao: "bla bla bla", imagem: require('../assets/integrantes/henrique.png') },
  { id: '4', nome: "LILY", descricao: "bla bla bla", imagem: require('../assets/integrantes/lily.png') },
  { id: '5', nome: "MARIA EDUARDA", descricao: "bla bla bla", imagem: require('../assets/integrantes/maria.png') },
  { id: '6', nome: "SABRINA KAORI", descricao: "bla bla bla", imagem: require('../assets/integrantes/sabrina.png') },
];
